...
class _ProductsScreenState extends State<ProductsScreen> {
                    ...
                    body: Column(
                      children: List.generate(listaProdutosPlanejados.length,
                        ...
                        return ProductListItem(
                          ...
                          checkboxClick: _toggleProductStatus,
  ...
  _toggleProductStatus({required Product product, required String listinId}) {
    _productService.addProduct(listinId: listinId, produto: product);
  }
